...
public:
	...
	UPROPERTY(VisibleAnywhere, Category = "Wwise", meta = (DisplayName = "Property to control"))
	FAkPropertyToControl ThePropertyToControl;

	UPROPERTY(Config, VisibleAnywhere, Category = "Wwise", meta = (DisplayName = "Item to control"))
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Wwise", meta = (Keywords = "Set Item Id"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Wwise", meta = (Keywords = "Get Item Id"))
	const FGuid GetAkSliderItemId() const;

	/** Set the item property to the new one.
	*  @param ItemId - value (new id) to set
	*/
	UFUNCTION(BlueprintCallable, Category = "Wwise", meta = (Keywords = "Set Item Property"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Wwise", meta = (Keywords = "Get Item Property"))
